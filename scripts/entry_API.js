...
const CONFIG = {
    ...
    scriptUrl: "https://script.google.com/macros/s/AKfycbz6ej-3aOh_clanRfuc1-wC1PyD4v2HI_I-2-LmGVo2Rict047fCJJxmmDS2LrQx2an/exec",
    ...
    fetch(CONFIG.scriptUrl, {
        ...
        .then(result => {
            if (result.result === 'success') {
                ...
                document.getElementById('resultLabel').textContent = athleteName.toUpperCase() + " - SERIAL(Sl.) NO";
