...
export function initLiveDashboard() {
    ...
    onSnapshot(doc(db, 'system_metadata', 'filters'), (docSnap) => {
        if (docSnap.exists()) {
...
function renderDashboard() {
    ...
    processedScores.forEach(score => {
        ...
        const finalScoreText = score.isFullyScored ? score.olympicSum.toFixed(2) : '...';
        ...
        tr.innerHTML = `
            ...
            <td class="p-4 text-right font-black text-green-400">${finalScoreText}</td>
